  ...
  <div className="video__player-description-mobile">
   <div className="header_description-mobile">
    ...
    <div className="chewron_container">
     <button>
      <img
       src="/first_layout/images/sidebar/RightArrowBlack.svg"
       alt="arrow-down"
       class="arrow_img"
      />
     </button>
   ...
   <div className="scroll_functional_container">
    <button className="func-container-button-mobile">
     <img src="/first_layout/images/functional-icons/like.svg" alt="like" />
     <p>123k</p>
    </button>
    <button className="func-container-button-mobile">
     <img src="/first_layout/images/functional-icons/dislike.svg" alt="dislike" />
     <p>435k</p>
    </button>
    <button className="func-container-button-mobile">
     <img src="/first_layout/images/functional-icons/share.svg" alt="share" />
     <p>Share</p>
    </button>
   </div>
  </div>
